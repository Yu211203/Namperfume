...
import com.ex.namperfume.entity.InvalidatedToken;
...
import com.ex.namperfume.repository.InvalidatedTokenRepository;
...
public class AuthenticationService {
    ...
    public AuthenticationResponse authenticate (AuthenticationRequest request){
        ...
        var user = userRepository.findByEmail(request.getEmail()).orElseThrow(()-> new AppException(EnumCode.USER_NOT_EXIST));
